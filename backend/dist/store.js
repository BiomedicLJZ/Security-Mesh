...
exports.alerts = exports.incidents = exports.nodes = void 0;
...
exports.alerts = [
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[0].id,
        incidentTitle: exports.incidents[0].title,
        type: 'fire',
        severity: 'CRITICAL',
        message: 'CRITICAL fire incident at East Industrial Zone. All fire units respond immediately. Evacuate 500m radius.',
        location: exports.incidents[0].location,
        status: 'active',
        responderUnit: 'Fire-Brigade-Alpha',
        createdAt: exports.incidents[0].createdAt,
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[1].id,
        incidentTitle: exports.incidents[1].title,
        type: 'cyber',
        severity: 'CRITICAL',
        message: 'CRITICAL cyber attack in progress. Isolate affected systems immediately. Activate incident response team.',
        location: exports.incidents[1].location,
        status: 'acknowledged',
        responderUnit: 'Cyber-Response-Team',
        createdAt: exports.incidents[1].createdAt,
        acknowledgedAt: hoursAgo(2.5),
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[2].id,
        incidentTitle: exports.incidents[2].title,
        type: 'hazmat',
        severity: 'HIGH',
        message: 'HIGH priority hazmat incident at West Harbor. HazMat-1 respond. Establish perimeter.',
        location: exports.incidents[2].location,
        status: 'acknowledged',
        responderUnit: 'HazMat-Unit-1',
        createdAt: exports.incidents[2].createdAt,
        acknowledgedAt: hoursAgo(3.5),
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[3].id,
        incidentTitle: exports.incidents[3].title,
        type: 'intrusion',
        severity: 'CRITICAL',
        message: 'CRITICAL armed intrusion. All patrol units to Sunset Complex. Approach with caution.',
        location: exports.incidents[3].location,
        status: 'active',
        responderUnit: 'Police-Unit-7',
        createdAt: exports.incidents[3].createdAt,
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[5].id,
        incidentTitle: exports.incidents[5].title,
        type: 'medical',
        severity: 'HIGH',
        message: 'HIGH priority medical emergency - cardiac arrest. Ambulance ETA 4 minutes. AED required.',
        location: exports.incidents[5].location,
        status: 'active',
        responderUnit: 'Ambulance-Delta-2',
        createdAt: exports.incidents[5].createdAt,
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[6].id,
        incidentTitle: exports.incidents[6].title,
        type: 'natural_disaster',
        severity: 'HIGH',
        message: 'HIGH priority flood warning. Emergency services on standby. Evacuation routes active.',
        location: exports.incidents[6].location,
        status: 'active',
        responderUnit: 'Emergency-Management',
        createdAt: exports.incidents[6].createdAt,
    },
    {
        id: (0, uuid_1.v4)(),
        incidentId: exports.incidents[7].id,
        incidentTitle: exports.incidents[7].title,
        type: 'hazmat',
        severity: 'HIGH',
        message: 'HIGH priority suspicious package. Bomb disposal en route. Clear 200m radius.',
        location: exports.incidents[7].location,
        status: 'active',
        responderUnit: 'Bomb-Disposal-Unit',
        createdAt: exports.incidents[7].createdAt,
    },
];
